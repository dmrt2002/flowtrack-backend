...
var OllamaPitchService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.OllamaPitchService = void 0;
const common_1 = require("@nestjs/common");
const axios_1 = __importDefault(require("axios"));
let OllamaPitchService = OllamaPitchService_1 = class OllamaPitchService {
    logger = new common_1.Logger(OllamaPitchService_1.name);
    ollamaUrl = process.env.OLLAMA_API_URL || 'http://localhost:11434/api/generate';
    model = process.env.OLLAMA_MODEL || 'llama3';
    async generatePitch(context, customPrompt, temperature) {
        try {
            ...
            const response = await axios_1.default.post(this.ollamaUrl, request, {
                timeout: 120000,
    ...
    async checkOllamaAvailable() {
        try {
            const response = await axios_1.default.get(`${this.ollamaUrl.replace('/api/generate', '/api/tags')}`, {
                timeout: 5000,
            });
...
exports.OllamaPitchService = OllamaPitchService;
exports.OllamaPitchService = OllamaPitchService = OllamaPitchService_1 = __decorate([
    (0, common_1.Injectable)()
], OllamaPitchService);
//# sourceMappingURL=ollama-pitch.service.js.map