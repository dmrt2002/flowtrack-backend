...
const oauth_service_1 = require("./src/modules/oauth/oauth.service");
async function testAutoFetchUrl() {
    const app = await core_1.NestFactory.createApplicationContext(app_module_1.AppModule);
    try {
        const oauthService = app.get(oauth_service_1.OAuthService);
...
testAutoFetchUrl();
//# sourceMappingURL=test-auto-fetch-url.js.map